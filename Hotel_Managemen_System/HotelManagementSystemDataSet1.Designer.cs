...
namespace Hotel_Managemen_System {
    ...
    public partial class HotelManagementSystemDataSet1 : global::System.Data.DataSet {
        ...
        public partial class BookingTblDataTable : global::System.Data.TypedTableBase<BookingTblRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BookingTblRow AddBookingTblRow(int Customer, int Room, System.DateTime BookDate, int Duration, int Cost) {
...
namespace Hotel_Managemen_System.HotelManagementSystemDataSet1TableAdapters {
    ...
    public partial class BookingTblTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[BookingTbl] WHERE (([BookId] = @Original_BookId) AND ([Custome" +
                "r] = @Original_Customer) AND ([Room] = @Original_Room) AND ([BookDate] = @Origin" +
                "al_BookDate) AND ([Duration] = @Original_Duration) AND ([Cost] = @Original_Cost)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[BookingTbl] ([Customer], [Room], [BookDate], [Duration], [Cost" +
                "]) VALUES (@Customer, @Room, @BookDate, @Duration, @Cost);\r\nSELECT BookId, Custo" +
                "mer, Room, BookDate, Duration, Cost FROM BookingTbl WHERE (BookId = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[BookingTbl] SET [Customer] = @Customer, [Room] = @Room, [BookDate] = @BookDate, [Duration] = @Duration, [Cost] = @Cost WHERE (([BookId] = @Original_BookId) AND ([Customer] = @Original_Customer) AND ([Room] = @Original_Room) AND ([BookDate] = @Original_BookDate) AND ([Duration] = @Original_Duration) AND ([Cost] = @Original_Cost));
SELECT BookId, Customer, Room, BookDate, Duration, Cost FROM BookingTbl WHERE (BookId = @BookId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookId, Customer, Room, BookDate, Duration, Cost FROM dbo.BookingTbl";
        ...
        public virtual int Fill(HotelManagementSystemDataSet1.BookingTblDataTable dataTable) {
        ...
        public virtual HotelManagementSystemDataSet1.BookingTblDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HotelManagementSystemDataSet1.BookingTblDataTable dataTable = new HotelManagementSystemDataSet1.BookingTblDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HotelManagementSystemDataSet1.BookingTblDataTable dataTable) {
        ...
        public virtual int Delete(int Original_BookId, int Original_Customer, int Original_Room, System.DateTime Original_BookDate, int Original_Duration, int Original_Cost) {
        ...
        public virtual int Insert(int Customer, int Room, System.DateTime BookDate, int Duration, int Cost) {
        ...
        public virtual int Update(int Customer, int Room, System.DateTime BookDate, int Duration, int Cost, int Original_BookId, int Original_Customer, int Original_Room, System.DateTime Original_BookDate, int Original_Duration, int Original_Cost, int BookId) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Customer, int Room, System.DateTime BookDate, int Duration, int Cost, int Original_BookId, int Original_Customer, int Original_Room, System.DateTime Original_BookDate, int Original_Duration, int Original_Cost) {
            return this.Update(Customer, Room, BookDate, Duration, Cost, Original_BookId, Original_Customer, Original_Room, Original_BookDate, Original_Duration, Original_Cost, Original_BookId);
        }
    }
